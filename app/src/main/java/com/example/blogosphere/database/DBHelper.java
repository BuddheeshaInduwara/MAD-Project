...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public int countComments(String blogId) {
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT * FROM " + COMMENT_TABLE_NAME + " WHERE " + COLUMN_NAME_COMMENT_BLOG_ID + "=?";
        Cursor cursor = db.rawQuery(query, new String[]{blogId});
    ...
    public List<CommentModal> getALLComments( String blogId ) {
